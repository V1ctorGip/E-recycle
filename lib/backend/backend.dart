...
import 'schema/fornecedor_record.dart';
...
export 'schema/fornecedor_record.dart';
...
/// Functions to query FornecedorRecords (as a Stream and as a Future).
Future<int> queryFornecedorRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FornecedorRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FornecedorRecord>> queryFornecedorRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FornecedorRecord.collection,
      FornecedorRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FornecedorRecord>> queryFornecedorRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<FornecedorRecord>> queryFornecedorRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
