...
class _$PontoDeColetaRecordSerializer
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[
      'local',
      serializers.serialize(object.local,
          specifiedType: const FullType(LocalStruct)),
    ];
    Object? value;
    value = object.nome;
    if (value != null) {
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'Status':
          ...
          break;
        case 'local':
          result.local.replace(serializers.deserialize(value,
              specifiedType: const FullType(LocalStruct))! as LocalStruct);
          break;
...
class _$PontoDeColetaRecord extends PontoDeColetaRecord {
  ...
  _$PontoDeColetaRecord._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        local, r'PontoDeColetaRecord', 'local');
  }
...
class PontoDeColetaRecordBuilder
  ...
  LocalStructBuilder? _local;
  LocalStructBuilder get local => _$this._local ??= new LocalStructBuilder();
  set local(LocalStructBuilder? local) => _$this._local = local;
  ...
  _$PontoDeColetaRecord _build() {
    _$PontoDeColetaRecord _$result;
    try {
      _$result = _$v ??
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PontoDeColetaRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
